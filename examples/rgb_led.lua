...
littlewire.softPWM_state(lw_dev, 1)
...
while true do
  ...
  while i < 255 do
      greenVal = greenVal + 1
      redVal = redVal - 1
      littlewire.softPWM_write(lw_dev, 255 - redVal, 255 - greenVal, 0)
  ...
  while i < 255 do
      redVal = redVal + 1
      blueVal = blueVal - 1
      littlewire.softPWM_write(lw_dev, 255-redVal, 0, 255 - blueVal)
      littlewire.delay(delayTime)
      i = i + 1
  end  
  ...
  while i < 255 do
      blueVal = blueVal + 1
      greenVal = greenVal - 1
      littlewire.softPWM_write(lw_dev, 0, 255 - greenVal, 255 - blueVal)
      littlewire.delay(delayTime)
      i = i + 1
  end
end
